...
limite=50
pescado=int(input("PESO DE PEIXE PESCADO EM QUILOGRAMAS: "))
print()

excesso=pescado-limite
multa=excesso*4

print(f"PESCADO DO DIA: {pescado}KG")
print(f"LIMITE DE PESCA: {limite}KG")
print(f"PESO EXCEDIDO: {excesso}KG")
print(f"MULTA DO DIA: R${multa:.2f}")